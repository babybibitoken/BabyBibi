...
contract BabyBibi is Context, IERC20, Ownable {
    ...
    string private _name     = "Baby Bibi";
    string private _symbol   = "BABYBIBI";
    ...
    uint256 public _buybackBurnFee;
    ...
    {        
        ...
        marketingWallet = 0xc966398127BAdcA0c8c4F9282b42c65A2f2D121C;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tBuybackBurn = calculateLiquidityFee(tAmount);
    ...
    function _takeLiquidity(uint256 tBuybackBurn) private {
        if (tBuybackBurn > 0) {
            uint256 currentRate =  _getRate();
            uint256 rBuybackBurn = tBuybackBurn * currentRate;
    ...
    function setBuyFeePercentages(uint256 _taxFeeonBuy, uint256 _buybackBurnFeeOnBuy, uint256 _marketingFeeonBuy) external onlyOwner {
        ...
        require(totalBuyFees <= 3, "Buy fees cannot be greater than 3%");
    ...
    function setSellFeePercentages(uint256 _taxFeeonSell, uint256 _buybackBurnFeeOnSell, uint256 _marketingFeeonSell) external onlyOwner {
        ...
        require(totalSellFees <= 7, "Sell fees cannot be greater than 7%");
